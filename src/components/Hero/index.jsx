        ...
        <div>
          <h1>
            <span className={"job-intro"}>
              Hi, I'm Johan Hauteville{" "}
              <span className={"job-shaking-hand"}>👋🏼</span>
            </span>{" "}
            <br />
            <span className={"job-name"}>Front</span>end
            <br />
            Developper
          </h1>
          <p>
            Actuellement basé à Montpellier, spécialisé dans la technologie{" "}
