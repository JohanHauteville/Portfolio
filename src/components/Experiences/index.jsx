        ...
        <div className="experiences-container">
          ...
          <Timeline className={"timeline"}>
            <TimelineItem>
              ...
              >
                <strong>
                  Formation Développeur d'Application Frontend - React
                </strong>
                <br />
                OpenClassrooms
                <br />
            ...
            <TimelineItem>
              ...
              <TimelineContent sx={{ fontSize: "calc(10px + 1vmin)" }}>
                <strong>
                  Co-Fondateur:
                  <br />
                  Biscuiterie Kris et Jo
                </strong>
                <br />
                Gestion de l'entreprise, création graphique, création et gestion
                du e-commerce.
                <br />
                <br />
              </TimelineContent>
            ...
            <TimelineItem>
              ...
              >
                ...
                CDI, Montpellier
                <br />
                Chargé de communication, gestion du parc informatique,
            ...
            {short === true ? (
              ...
              <>
                <TimelineItem>
                  ...
                  <TimelineContent
                    sx={{ fontSize: "calc(10px + 1vmin)", paddingLeft: "0" }}
                  >
                    <strong>
                      Graphiste maquétiste VFX: <br />
                      Freelance
                    </strong>
                    <br />
                    Réalisation de plaquettes, de cartes de visite et de vidéos
                    marketing.
                    <br />
                    <br />
                  </TimelineContent>
                ...
                <TimelineItem>
                  ...
                  >
                    <strong>
                      Animateur 3D / Graphiste 2D
                      <br />
                      IP. Studio
                    </strong>
                    <br />
                    Co-Fondateur, Montpellier
                    <br />
                    Responsable du pôle création des animations 3D d'un jeu
                    mobile.
                    <br />
                    <br />
                  </TimelineContent>
